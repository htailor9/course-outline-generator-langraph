...
$env:AWS_PROFILE = "my-profile"        # or AWS_ACCESS_KEY_ID / AWS_SECRET_ACCESS_KEY [/ AWS_SESSION_TOKEN]
```
...
models:                                # Bedrock model IDs (check exact ids in your Bedrock console;
  default: anthropic.claude-sonnet-4-5-v1:0        # cross-region models use the us./eu. prefix,
  annotate: anthropic.claude-haiku-4-5-v1:0        # e.g. us.anthropic.claude-sonnet-4-5-v1:0)
  titles: anthropic.claude-haiku-4-5-v1:0
```
...
python -m outline generate tests\fixtures\sample-input-43.json --provider bedrock_converse --model us.anthropic.claude-sonnet-4-5-v1:0
```
