...
- `bedrock_converse` — use `python scripts\aws_saml_login.py --account-choice 3` to configure
  SAML-backed AWS credentials, then use Bedrock inference-profile model ids such
  as `us.anthropic.claude-sonnet-4-5-20250929-v1:0`
