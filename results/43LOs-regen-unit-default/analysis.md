# Run analysis — 20260901-172714_43LOs_Test-Math-regen-Counting-Combinatorics-N_claude_cli

Generated 2026-09-01T17:27:14 · provider **claude_cli** · models `{'default': 'sonnet', 'annotate': 'sonnet', 'titles': 'sonnet'}` · wall 84.0s
...
| 3 | 2 | Permutations And Combinations | 2 | 582 | 28 |  | Ordered Permutation Counting; Unordered Combination Counting |
| 3 | 3 | Number Base Systems | 1 | 291 | 14 |  | Binary Octal Hex Conversion |
| 3 | 4 | Multi-Step Counting Rules | 2 | 950 | 36 |  | Multiplication Principle Application; Repetition Arrangements With Exponents |
| 3 | 5 | Counting Strategy Selection | 2 | 950 | 36 |  | Inclusion-Exclusion Set Counting; Selecting Counting Strategies |
| 3 | 6 | Logic And Error Codes | 2 | 950 | 36 |  | Boolean Expression Simplification; Parity And Check Digits |
| 3 | 7 | Data Security And Compression | 2 | 950 | 36 |  | Calculating Compression Ratios; Modular Arithmetic Encryption |
| 3 | 8 | Algorithmic Efficiency Analysis | 1 | 659 | 26 |  | Time And Space Complexity |
...
| calls | 2 |
| prompt tokens | 94367 |
| completion tokens | 7819 |
| max single prompt | 49778 |
| tokens per LO | 2376.4 |

| node | calls | prompt tokens |
| --- | --- | --- |
| plan_chapters | 1 | 49778 |
| titles | 1 | 44589 |

| # | role | part/batch | model | prompt | completion | ms | attempt |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | plan_chapters | P2 | claude-sonnet-5 | 49778 | 6051 | 64716 | 1 |
| 2 | titles | 3 | claude-sonnet-5 | 44589 | 1768 | 19265 | 1 |
