# Run analysis — 20260831-113546_43LOs_Test-Math-Theme_claude_cli

Generated 2026-08-31T11:35:46 · provider **claude_cli** · models `{'default': 'sonnet', 'annotate': 'sonnet', 'titles': 'sonnet'}` · wall 64.1s
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | overview | Test_Math_Theme Course Overview | 1 | 0 | 2 | 0 | 0 | 60 |
| 2 | understand | Test_Math_Theme Core Concepts | 47 | 43 | 46 | 43 | 19873 | 1026 |
| 3 | semester | Test_Math_Theme Semester A Reflect & Review | 2 | 0 | 1 | 0 | 0 | 120 |
| 4 | semester | Test_Math_Theme Semester B Reflect & Review | 2 | 0 | 1 | 0 | 0 | 120 |
...
```
FINAL: Part 'Test_Math_Theme Core Concepts' - 43 understand chapters OK
```
